...
public static class Dispatcher
{
        ...
        bool v8Free)
    {
        ...
        // POCKETCALCULATOR_CDP_COMMAND_TIMEOUT_MS tunes the bound (0 disables); the default
        // leaves headroom for the slowest legitimate navigation, which already
        // self-bounds via POCKETCALCULATOR_NAV_TIMEOUT_MS plus the watchdog-bounded settle.
    ...
    {
        var raw = Environment.GetEnvironmentVariable("POCKETCALCULATOR_CDP_COMMAND_TIMEOUT_MS");
        if (raw is not null &&
