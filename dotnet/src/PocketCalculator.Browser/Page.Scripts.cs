...
public sealed partial class Page
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        ulong scriptDeadlineMs = PageHelpers.EnvUlong("POCKETCALCULATOR_SCRIPT_DEADLINE_MS", 30_000);
        ...
        int bodyNodes = Js?.WithDom(dom =>
            dom.TryQuerySelector("body", out NodeId? body, out _) && body is { } id
                ...
                : 0) ?? 0;
        ulong shortMs = moduleBudgetOverride ?? PageHelpers.EnvUlong("POCKETCALCULATOR_MODULE_BUDGET_MS", 3_000);
