...
using TaffyAlignContent = PocketCalculator.Render.Layout.AlignContent;
...
using TaffyBoxSizing = PocketCalculator.Render.Layout.BoxSizing;
...
using TaffyJustifyContent = PocketCalculator.Render.Layout.AlignContent;
using TaffyLayout = PocketCalculator.Render.Layout.Layout;
