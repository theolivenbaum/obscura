...
namespace PocketCalculator.Render.Css;
...
/// </summary>
/// <remarks>
/// <see cref="SelectorParses"/> is wired to PocketCalculator.Dom's real selector parser
/// and <see cref="SupportsDeclaration"/> to the style.rs port's
/// <see cref="PocketCalculator.Render.ComputedStyle.SupportsDeclaration"/>, so
...
public static class CssHost
{
    ...
    public static Func<string, string, bool> SupportsDeclaration { get; set; } =
        PocketCalculator.Render.ComputedStyle.SupportsDeclaration;
    ...
    {
        SupportsDeclaration = PocketCalculator.Render.ComputedStyle.SupportsDeclaration;
...
internal static class CssSupportsOracle
{
    ...
    private static readonly HashSet<string> KnownProperties = new(StringComparer.Ordinal)
    {
        ...
        "content", "-webkit-text-fill-color", "fill", "stroke", "stroke-width", "text-anchor",
        "border-color",
