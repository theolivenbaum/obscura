...
/// <c>NodeId</c>. The DOM port lives in <c>PocketCalculator.Dom</c>, so the predicates
...
/// seam because the selector engine lives in <c>PocketCalculator.Dom</c>; the default
