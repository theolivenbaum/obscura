...
/// <see cref="PocketCalculator.Render.BorderModel"/>, <see cref="OutlineModel"/>, <see cref="ObjectPosition"/>,
...
internal sealed class LayoutStyleRare
{
    ...
    public AnimationTiming AnimationTiming = PocketCalculator.Render.AnimationTiming.Default;
    ...
    public ObjectPosition ObjectPosition = PocketCalculator.Render.ObjectPosition.Default;
...
public sealed class LayoutStyle
{
    ...
    /// </remarks>
    public BorderModel BorderModel = PocketCalculator.Render.BorderModel.Default;
    ...
    /// visible.
    /// </summary>
    public BackgroundOrigin BackgroundOrigin = PocketCalculator.Render.BackgroundOrigin.PaddingBox;

    public BackgroundClip BackgroundClip = PocketCalculator.Render.BackgroundClip.BorderBox;
    ...
    {
        get => m_rare is null ? PocketCalculator.Render.AnimationTiming.Default : m_rare.AnimationTiming;
        set
        {
            if (m_rare is not null || value != PocketCalculator.Render.AnimationTiming.Default)
            {
    ...
    /// collapse to <see cref="PocketCalculator.Render.Display.Inline"/>, since this engine has no
    ...
    {
        get => m_rare is null ? PocketCalculator.Render.ObjectPosition.Default : m_rare.ObjectPosition;
        set
        {
            if (m_rare is not null || value != PocketCalculator.Render.ObjectPosition.Default)
            {
    ...
    internal bool IgnoresUsedBoxSizes() =>
        Display == PocketCalculator.Render.Display.Inline && !IsInlineBlock && !IsReplacedBox;
