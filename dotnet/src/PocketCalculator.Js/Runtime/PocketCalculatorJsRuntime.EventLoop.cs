...
/// <see cref="PocketCalculator.Js.Ops.AsyncOpBinding"/> is the async-op counter, and V8's
...
public sealed partial class PocketCalculatorJsRuntime
{
    ...
    /// </remarks>
    public async Task<bool> ResolvePromisesUntilAsync(Func<PocketCalculatorJsRuntime, bool> doneCheck, ulong maxTotalMs)
    {
