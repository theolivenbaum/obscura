...
public static class RenderOps
{
    ...
    /// </summary>
    public static void OpBeginRenderTask(PocketCalculatorState state) =>
    ...
    /// </summary>
    public static bool OpSetDynamicFonts(PocketCalculatorState state, string registrations) => OpGuard.Run(
    ...
    /// </para>
    /// </remarks>
    public static bool OpFontResourceLoaded(PocketCalculatorState state, string url) => OpGuard.Run(
    ...
    /// </summary>
    public static bool OpCanvasPaintDamage(PocketCalculatorState state, uint nid) => OpGuard.Run(
    ...
    /// </remarks>
    public static string OpLayoutGeometry(PocketCalculatorState state, string nidStr) => OpGuard.Run(
        "op_layout_geometry",
        () =>
        {
            ArgumentNullException.ThrowIfNull(state);
    ...
    /// </remarks>
    public static string OpResizeObserverMeasurements(PocketCalculatorState state, string nidsJson) => OpGuard.Run(
    ...
    /// </summary>
    public static string OpIntersectionObserverMeasurements(PocketCalculatorState state, string nidsJson) =>
        OpGuard.Run(
    ...
    /// </summary>
    public static string OpComputedStyle(PocketCalculatorState state, string nidStr) =>
    ...
    /// </summary>
    public static string OpLayoutMetrics(PocketCalculatorState state) => OpGuard.Run(
        "op_layout_metrics",
        () =>
        {
            ArgumentNullException.ThrowIfNull(state);
    ...
    public static string OpElementScrollMetrics(PocketCalculatorState state, string nidStr) => OpGuard.Run(
    ...
    public static string OpElementScrollTo(PocketCalculatorState state, string nidStr, double x, double y) =>
        OpGuard.Run(
    ...
    public static string OpScrollOffset(PocketCalculatorState state) => OpGuard.Run(
        "op_scroll_offset",
        () =>
        {
            ArgumentNullException.ThrowIfNull(state);
    ...
    public static string OpScrollTo(PocketCalculatorState state, double x, double y) => OpGuard.Run(
        "op_scroll_to",
        () =>
        {
            ArgumentNullException.ThrowIfNull(state);
    ...
    /// </summary>
    public static string OpImageMetadata(PocketCalculatorState state, uint nid, bool cachedOnly) => OpGuard.Run(
        "op_image_metadata",
        () =>
        {
            ArgumentNullException.ThrowIfNull(state);
    ...
    /// </remarks>
    public static Task<string> OpLoadImageMetadataAsync(PocketCalculatorState state, uint nid) =>
        OpGuard.RunAsync(
    ...
    /// document timeline.
    /// </summary>
    public static bool OpWaapiCreate(PocketCalculatorState state, string input) => OpGuard.Run(
        "op_waapi_create",
        () =>
        {
            ArgumentNullException.ThrowIfNull(state);
    ...
    public static bool OpWaapiControl(PocketCalculatorState state, double id, string action, double value) =>
        OpGuard.Run(
            "op_waapi_control",
            () =>
            {
    ...
    internal static float WaapiDocumentTimeMs(PocketCalculatorState state) =>
    ...
    /// </summary>
    private static void InvalidateWaapiRender(PocketCalculatorState state, NodeId node)
    {
    ...
    private static (string Url, float Density, bool Known, (float Width, float Height)? Dimensions)?
        ProfiledCachedImageMetadata(PocketCalculatorState gs, NodeId nodeId)
    {
    ...
    private static string CachedImageMetadataForNode(PocketCalculatorState gs, NodeId nodeId) =>
    ...
    /// </summary>
    private static string LoadImageMetadataWithoutPageTransport(PocketCalculatorState gs, NodeId nodeId)
    {
        var baseUrl = StateHelpers.DocumentBaseUrlMemoized(gs);
    ...
    private static async Task<string> LoadImageMetadataAsync(PocketCalculatorState shared, uint nid)
    {
