...
/// <remarks>
/// <para>
/// This is the port of <c>PocketCalculatorState</c> in <c>crates/obscura-js/src/ops.rs</c>.
/// The Rust engine holds it as <c>Rc&lt;RefCell&lt;PocketCalculatorState&gt;&gt;</c>; the C# port
...
public sealed class PocketCalculatorState
{
    ...
    {
        private readonly PocketCalculatorState _state;

        internal ExclusiveScope(PocketCalculatorState state)
        {
            _state = state;
            state._borrowDepth++;
        }
