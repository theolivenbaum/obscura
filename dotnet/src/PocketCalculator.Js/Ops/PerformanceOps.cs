...
public static class PerformanceOps
{
    ...
    public static void RecordResourceTiming(PocketCalculatorState state, ResourceTimingRecord record)
    {
    ...
    /// </summary>
    public static string OpResourceTimings(PocketCalculatorState state, double sinceIndex) => OpGuard.Run(
        "op_resource_timings",
        () =>
        {
            ArgumentNullException.ThrowIfNull(state);
    ...
    /// </summary>
    public static double OpResourceTimingCount(PocketCalculatorState state) => OpGuard.Run(
