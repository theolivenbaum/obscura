...
/// normalizers in <see cref="PocketCalculatorOps"/> still run, so op semantics are unchanged;
...
internal static class FastOpBinding
{
    ...
    /// <summary>
    /// <c>POCKETCALCULATOR_OP_PROFILE=1</c> prints a running total of time spent per op.
    /// </summary>
    /// <remarks>
    ...
    internal static class OpProfile
    {
        public static readonly bool Enabled =
            Environment.GetEnvironmentVariable("POCKETCALCULATOR_OP_PROFILE") is not null;
    ...
    /// <see cref="PocketCalculatorOps"/> see exactly what they saw before.
    /// </summary>
