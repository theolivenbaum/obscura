...
/// <see cref="PocketCalculator.Net.WhatwgEncoding"/>, which resolves the whole WHATWG label
...
public static class QueryEncoding
{
    ...
    /// </summary>
    private static void EncodeRun(StringBuilder output, ReadOnlySpan<char> run, PocketCalculator.Net.WhatwgEncoding encoder)
    {
    ...
    /// </summary>
    private static PocketCalculator.Net.WhatwgEncoding? ResolveEncoder(string label) =>
        PocketCalculator.Net.WhatwgEncoding.ForLabel(label);
}
