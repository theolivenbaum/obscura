...
public abstract record InterceptAction
{
    ...
    /// <summary>Fail the request with <c>PocketCalculatorNetError::Blocked</c>.</summary>
...
/// <summary>A request interceptor installed on <see cref="PocketCalculatorHttpClient"/>.</summary>
