...
/// <c>--allow-private-network</c> or <c>POCKETCALCULATOR_ALLOW_PRIVATE_NETWORK</c>.
/// </summary>
public static class SsrfGuard
{
    ...
    {
        var raw = Environment.GetEnvironmentVariable("POCKETCALCULATOR_ALLOW_PRIVATE_NETWORK");
        if (raw is null)
        {
            return false;
        }
...
/// (<c>--allow-private-network</c> or <c>POCKETCALCULATOR_ALLOW_PRIVATE_NETWORK</c>) the
