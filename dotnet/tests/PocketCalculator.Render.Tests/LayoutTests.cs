...
// ported in dotnet/src/PocketCalculator.Render/Layout:
//
...
// feature is part of this port (Obscura parses CSS in PocketCalculator.Render.Css, and
// styles never cross a serialization boundary).
namespace PocketCalculator.Render.Tests;

// These usings sit inside the namespace on purpose: PocketCalculator.Render (the computed
...
using Xunit;
using BoxSizing = PocketCalculator.Render.Layout.BoxSizing;
using Clear = PocketCalculator.Render.Layout.Clear;
using Dimension = PocketCalculator.Render.Layout.Dimension;
using Display = PocketCalculator.Render.Layout.Display;
using Float = PocketCalculator.Render.Layout.Float;
