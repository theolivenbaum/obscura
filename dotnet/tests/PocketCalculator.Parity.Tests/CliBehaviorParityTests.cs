...
using PocketCalculator.Parity.Tests.Harness;
using Xunit;

namespace PocketCalculator.Parity.Tests;
...
public sealed class CliBehaviorParityTests
{
    ...
    /// </summary>
    /// <remarks>
    /// BLOCKED on the recorded PocketCalculator.Browser issue: <c>PageUrl.TryParse</c>
    ...
    /// cause; the fix is migrating <c>PocketCalculator.Browser</c> onto
    /// <c>PocketCalculator.Js.Url.UrlRecord</c>. stdout is unaffected, which
    ...
    /// the WHATWG parser.
    /// </remarks>
    [Fact(Skip = "PocketCalculator.Browser serializes URLs through System.Uri; see 'Open issues' in todo.md")]
