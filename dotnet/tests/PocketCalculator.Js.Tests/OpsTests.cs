...
public sealed class OpsTests
{
    ...
    /*  Rust original:
        ...
        async fn posted_task_chains_complete_without_zero_delay_timer_floor() {
            let mut runtime = PocketCalculatorJsRuntime::new();
    ...
    */
    ...
    private static WeakReference<PocketCalculatorState> OwnerContentionScope()
    {
        var owner = new PocketCalculatorState();
