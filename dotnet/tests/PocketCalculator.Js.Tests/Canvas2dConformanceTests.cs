...
{
    private static PocketCalculatorJsRuntime NewRuntime()
    {
        var rt = new PocketCalculatorJsRuntime();
    ...
    private static int Painted(PocketCalculatorJsRuntime rt, string draw)
    {
