...
/// </summary>
internal sealed class CaptureRuntime(PocketCalculatorJsRuntime runtime) : IDisposable
{
    public PocketCalculatorJsRuntime Runtime { get; } = runtime;
...
internal static class RenderCaptureSupport
{
    ...
    public static float AnimationTestWidth(PocketCalculatorJsRuntime runtime, string id)
    {
