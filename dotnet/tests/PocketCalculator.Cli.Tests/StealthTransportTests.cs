...
/// at <c>POCKETCALCULATOR_PROFILE=0</c>, which is also the default profile).
/// </para>
/// <para>
...
public sealed class StealthTransportTests
{
    ...
    /// <summary>The default profile's UA, which is also <c>POCKETCALCULATOR_PROFILE=0</c>.</summary>
    ...
    [Fact(Skip = "the stealth transport (wreq/BoringSSL) has no managed equivalent: TLS "
        ...
        + "deviations\" in todo.md; PocketCalculator.Net.UnavailableStealthHttpClient is the seam.")]
